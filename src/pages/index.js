    ...
    return (
      <main className="">
        ...
        <div className='relative flex justify-between items-center max-w-[500px] w-full m-auto pt-4 text-white z-10'>
          <form onSubmit={fetchWeater} className='flex items-center justify-between w-full p-3 m-auto text-white bg-transparent border border-slate-500 rounded-2xl'>
            <div>
              <input onChange={(e) => setcity(e.target.value)} type='text' className='text-xl text-white bg-transparent border-none focus:outline-none' placeholder='Search City'></input>
            </div>
